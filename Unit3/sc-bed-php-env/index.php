...
echo '<h5>Assigment With Operation</h5>';
$a = 1;
printf('<p>The value of a is %d</p>', $a);
printf('<p>a+=5 = %d', $a+=5);
printf('<p>a-=4 = %d', $a-=4);

echo '<h5>Assigment By Value</h5>';
$a = 20;
...
echo '<h5>Assigment By Reference</h>';
$a = 20;
printf('<p>a starts with the value %d</p>', $a);
$b = &$a;
$b = 30;
...
if ($beanWeight >= 30 && $waterWeight >= 150) {
    echo '<p>Coffe machine is working...</p>';
} else {
...
$propectPermitExpires = 17;
$currentDay = 8;
do {
    echo "<p>Prospecting on day $currentDay</p>";
    $currentDay++;
} while ($currentDay <= $propectPermitExpires);
